...
<h3 class="mb-sm-0">Disbursement Tracker</h3>
...
<li class="breadcrumb-item active" aria-current="page">Disbursement Tracker</li>
</ol>
</nav>
</div>
</div>
...
<br>
<br>
<div  style="font-size:9px; text-transform:capitalize">
<div >
<div id="list"></div>
</div>
</div>
