...
$whereClause = "Status = ? AND $d < Maturity_Date AND Branch_id = '$branch_id'";
$params = ['Active'];
$types = 's';
...
$dataQuery = "SELECT id, Loan_Account_No, Firstname, Lastname, Middlename, Product, Branch, 
...
$filePath = '../data/branch_expired_portfolio_list.json';
