...
<img class="profile-user-img img-fluid img-circle" src="<?php echo $rows['Location']; ?>" alt="User profile picture" style="width:100px; height:100px; border-radius:100px">
</div>
<br>
<center>
...
<b><i class="fa fa-star"></i> Request Info</b><br>
...
<div class="col-sm-6">
<b style="margin-left: 8px;">Status:</b> <i><?php echo $row['Status']; ?></i>
</div>
</div>
<div class="row">
<div class="col-sm-12">
...
$("#please").show();
$.ajax({
url: "final_flexi_payout_bck.php",
type: "POST",
