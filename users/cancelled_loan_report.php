...
$Query = "SELECT  * FROM branch WHERE  Name != 'Head Office' ORDER BY id ASC";
...
<div class="col-sm-3">
<label>Loan Officer</label> <i id="load" style="display:none; float:right"><img src="../loader/loader.gif" style="height:14px"> Loading.....</i>
