...
$sql="INSERT INTO `users` (`Staff_ID`, `Name`, `Username`, `Password`, `Email`, `Role_id`, `User_Group`, `Role_Categorys`, `Usertype`, `Checks`, 
`Status`, `Branch`, `Branch_id`, `Location`, `User`, `Phone`, `Address`, `Active`, `Town`, `Pin`, `Access_Code`, `Mapped`, `Zone`, `Zone_id`, `Country`)
VALUES ('$staffid', '$nm', 'NA', 'NA', '$em', '$rol_id', '$gr_name', '$cat', 'User',  '0', 'Deactivate', '$br_name', '$br_id', '$path', 'Admin', '$ph', '$ad', 
'Offline', '$st', 'NA', 'NA', 'No', '$zn_name', '$zn_id', '$cnt')";
...
`Status`, `Branch`, `Branch_id`, `Location`, `User`, `Phone`, `Address`, `Active`, `Town`, `Pin`, `Access_Code`, `Mapped`, `Zone`, `Zone_id`, `Country`)
VALUES ('$staffid', '$nm', 'NA', 'NA', '$em', '$rol_id', '$gr_name', '$cat', 'User', '0', 'Deactivate', '$br_name', '$br_id', '$path', 'Admin', '$ph', '$ad', 
'Offline', '$st', 'NA', 'NA', 'Not Required', '$zn_name', '$zn_id', '$cnt')";
$row = mysqli_query($con, $sql);
if($row == true){
echo 2;
}else{
