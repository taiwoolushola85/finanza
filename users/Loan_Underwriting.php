...
<div class="toast-body">
<i class="fa fa-check"></i> Application Cancelled Successfully
</div>
</div>
</div>
...
<h3 class="mb-sm-0">Loan Underwriting</h3>
...
<li class="breadcrumb-item active" aria-current="page">Loan Underwriting</li>
</ol>
</nav>
</div>
</div>
