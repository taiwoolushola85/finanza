...
<i class="fa fa-check"></i> Client Transfered sSuccessfully
</div>
</div>
</div>
...
<input type="text" class="form-control" name="reg" id="reg" placeholder="Enter Loan Account No" required="required">
...
$.ajax({
url: "check_client_info.php?id=" + id,
type: "GET",
